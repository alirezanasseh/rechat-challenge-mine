...
import {IIcon} from '../../interfaces/general';

const AddIcon = (props: React.PropsWithChildren<IIcon>) => {
    const {
        width = '16px',
        height = '16px',
        color = 'white',
    ...
    return (
        <svg height={height} viewBox="0 0 448 448" width={width} xmlns="http://www.w3.org/2000/svg" className={additional_classes}>
            <path
                fill={color}
...
const EditIcon = (props: React.PropsWithChildren<IIcon>) => {
    const {
        width = '28px',
        height = '28px',
        color = 'black',
    ...
    return (
        <svg height={height} viewBox="0 0 512 511" width={width} xmlns="http://www.w3.org/2000/svg" className={additional_classes}>
            <path
                fill={color}
